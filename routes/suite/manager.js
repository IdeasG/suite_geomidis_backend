...
export const createManagerRouter = () => {
  ...
  //GET
  managerRouter.get("/sistemas", validarToken, managerController.getSistemas);
  ...
  managerRouter.post("/capas/supergrupo", managerController.saveSuperGrupoSistema);
  ...
  managerRouter.post("/capas/rol/orden", validarToken, managerController.saveOrdenByRol);
  managerRouter.get("/capas/rol/orden", validarToken, managerController.getOrdenByRol);
  managerRouter.get("/capas/rol/orden/invitado/:id_cliente", managerController.getOrdenByRolInvitado);
  //DELETE
  managerRouter.delete("/sistemas/modulo/:id", managerController.deleteModuloSistema);
  managerRouter.delete("/sistemas/grupo/:id", managerController.deleteGrupoSistema);
  managerRouter.delete("/sistemas/menu/:id", managerController.deleteMenuSistema);
  ...
  managerRouter.get("/clientes/sistemas/:id", managerController.getSistemasByClientes);

  //POST CLIENTES
  managerRouter.post("/clientes/sistemas", managerController.saveSistemasByCliente);
  ...
  managerRouter.post("/generate-token-reset-password", managerController.generateTokenResetPassword);
  managerRouter.post("/reset/password", managerController.sendMessage);
  managerRouter.post("/admin/newuser", managerController.adminNewUser);

  //GEOPORTALES
  managerRouter.post("/geoportales", validarToken, managerController.saveGeoportales);
  managerRouter.put("/geoportales/:id", validarToken, managerController.editGeoportales);
  managerRouter.delete("/geoportales/:id", validarToken, managerController.deleteGeoportales);
