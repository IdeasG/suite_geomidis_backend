...
export const createManagerRouter = () => {
  ...
  managerRouter.post(
    "/actividades/fotos",
    managerController.postActividadesFotos
  );
  //PUT
  managerRouter.put(
    "/actividades/:id_actividad",
    managerController.updateActividades
  );
  //DELETE
  managerRouter.delete(
    "/actividades/:id_actividad",
    managerController.deleteActividades
  );
  managerRouter.delete(
    "/actividades/fotos/:id_foto",
    managerController.deleteActividadesFotos
  );
